...
@Component({
  selector: 'app-imagen4',
  templateUrl: './imagen4.component.html',
  styleUrls: ['./imagen4.component.css'],
  providers: [DatePipe]
})
export class Imagen4Component implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<Imagen4Component>,
