...
@Component({
  selector: 'app-imagen2',
  templateUrl: './imagen2.component.html',
  styleUrls: ['./imagen2.component.css'],
  providers: [DatePipe]
})
export class Imagen2Component implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<Imagen2Component>,
