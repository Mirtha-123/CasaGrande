...
@Component({
  selector: 'app-imagen3',
  templateUrl: './imagen3.component.html',
  styleUrls: ['./imagen3.component.css'],
  providers: [DatePipe]
})
export class Imagen3Component implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<Imagen3Component>,
